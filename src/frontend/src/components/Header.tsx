      ...
      <div className="mx-auto flex h-full max-w-[1440px] items-center px-4 lg:px-[100px]">
        ...
        <div className="hidden lg:flex items-center gap-4">
          ...
          <a
            ...
            className="rounded-[12px] border-2 border-bleu px-[18px] py-1.5 text-sm font-bold text-bleu hover:bg-bleu hover:text-blanc transition-colors"
          >
            {tCta("becomePartner")}
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="rounded-[12px] bg-bleu px-[18px] py-1.5 text-sm font-bold text-blanc hover:bg-bleu/90 transition-colors"
          >
            {tCta("submitTalk")}
          </a>
          <LanguageSwitcher />
        ...
        >
          <div className="flex flex-col gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-[12px] border-2 border-bleu px-[18px] py-3 text-sm font-bold text-bleu text-center"
            >
              {tCta("becomePartner")}
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-[12px] bg-bleu px-[18px] py-3 text-sm font-bold text-blanc text-center"
            >
              {tCta("submitTalk")}
            </a>
