          ...
          <div className="mx-auto mt-8 max-w-[110rem]">
            <ProgrammeBrowser
              ...
              labels={{
                ...
                exportMenuTitle: t("exportMenuTitle"),
                share: t("share"),
                shareTitle: t("shareTitle"),
                shareCopied: t("shareCopied"),
                shareFailed: t("shareFailed"),
                shareEmptyTitle: t("shareEmptyTitle"),
                shareEmptyBody: t("shareEmptyBody"),
                shareEmptyChoose: t("shareEmptyChoose"),
                shareEmptyConfirm: t("shareEmptyConfirm"),
                calendar: t("calendar"),
                exportAllTitle: tcal("exportAll"),
                exportMineTitle: tcal("exportMine"),
                exportTitle: tcal("exportAll"),
                printByTimeAction: t("printByTimeAction"),
                printByRoomAction: t("printByRoomAction"),
